    ...
    <div class="col-lg-8 d-flex align-items-center gap-3">
      <form method="get" class="d-flex flex-grow-1 gap-2">
        <input type="text" name="search" class="form-control" style="max-width: 300px;"
          placeholder="Search Email..." value="<?php echo htmlspecialchars($search); ?>">
          ...
          <tbody>
            ...
            ?>
              <tr class="invoice-row" data-status="<?php echo $status; ?>">
                <td><a href="./invoice-add.php"><span class="inv-number"><?php echo htmlspecialchars($row['id']); ?></span></a></td>
                <td>
                  <div class="d-flex">
                ...
                <td>
                  <div class="d-flex gap-2">
                    <a class="btn btn-sm btn-outline-primary" href="./invoice-preview.php?id=<?php echo $row['id']; ?>" target="_blank" rel="noopener noreferrer" title="View">
                    ...
                    <a class="btn btn-sm btn-outline-secondary" href="./invoice-add.php?u_id=<?php echo $row['id']; ?>" title="Edit">
                    ...
                    <a class="btn btn-sm btn-outline-danger" href="./invoice-add.php?d_id=<?php echo $row['id']; ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this invoice?');">
