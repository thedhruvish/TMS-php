...
<div class="container my-5">
  ...
  <select name="gender" class="form-select" required <?php echo $viewMode ? 'disabled' : '' ?>>
    <option value="" disabled <?php echo empty($row['gender']) ? 'selected' : '' ?>>Choose gender</option>
  ...
  <select name="country" class="form-select" required <?php echo $viewMode ? 'disabled' : '' ?>>
